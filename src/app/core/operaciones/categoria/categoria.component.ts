...
export class CategoriaComponent implements OnInit{
  ...
  private getTableData(): void {
    ...
    this.categoriaService.obtenerCategoria(env.clinicaId,this.currentPage, this.pageSize).subscribe((data: DataCategoria) => {
  ...
  editarCategoria(categoria: Icategoria) {
    ...
    this.bsModalRef.content.especialidadSeleccionada = categoria.nombre;
    this.bsModalRef.onHidden?.subscribe(() => {
      this.getTableData();
    });
  }
