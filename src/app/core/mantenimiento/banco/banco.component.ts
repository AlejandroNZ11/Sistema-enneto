...
export class BancoComponent {
  ...
  constructor(private modalService: BsModalService, public bancosService: BancosService) {
  }
  ngOnInit() {
    this.getTableData();
  }
  private getTableData(): void {
    ...
    this.bancosService.obtenerBancos("D30C2D1E-E883-4B2D-818A-6813E15046E6", this.currentPage, this.pageSize).subscribe((data: DataBancos) => {
